...
If you do not have any of these administrator rights, please refer to the [Instructions for Office 365 administrators to allow a user to install Badrap Office 365 app](./o365.md#instructions-for-office-365-administrators-to-allow-a-user-to-install-badrap-office-365-app) section below. 
